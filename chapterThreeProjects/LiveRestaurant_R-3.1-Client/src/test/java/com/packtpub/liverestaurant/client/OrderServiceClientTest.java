...
public class OrderServiceClientTest {
	...
	private static InputStream cancelOrderResponse;
	...
	public   void setUpBefore() {
    	...
    	cancelOrderRequest = new OrderServiceClientTest().getClass().getResourceAsStream("cancelOrderRequest.xml");
    	placeOrderResponse = new OrderServiceClientTest().getClass().getResourceAsStream("placeOrderResponse.xml");
    	cancelOrderResponse = new OrderServiceClientTest().getClass().getResourceAsStream("cancelOrderResponse.xml");
	}
	@After
