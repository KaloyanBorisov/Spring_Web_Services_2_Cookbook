...
public class OrderEndpoint {	
	...
	Source handleCancelOrderRequest(@RequestPayload Source source) throws Exception {
		...
		boolean cancelled =true ;	
			return new StringSource(
					"<tns:cancelOrderResponse xmlns:tns=\"http://www.packtpub.com/liverestaurant/OrderService/schema\"><tns:cancelled>"+(cancelled?"true":"false")+"</tns:cancelled></tns:cancelOrderResponse>");
	}
