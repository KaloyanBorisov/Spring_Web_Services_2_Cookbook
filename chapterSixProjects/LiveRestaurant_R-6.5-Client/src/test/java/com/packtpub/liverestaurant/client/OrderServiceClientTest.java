...
public class OrderServiceClientTest {
	...
	public   void testHandleCancelOrderRequest() throws Exception {
    	...
    	CancelOrderResponse cancelOrderResponse= orderServiceProxy.handleCancelOrderRequest(cancelOrderRequest);
	...
	public   void testHandleOrderRequest() throws Exception {
    	...
    	PlaceOrderResponse orderResponse= orderServiceProxy.handlePlaceOrderRequest(orderRequest);
    	Assert.assertTrue(orderResponse.getRefNumber().length()>0);
