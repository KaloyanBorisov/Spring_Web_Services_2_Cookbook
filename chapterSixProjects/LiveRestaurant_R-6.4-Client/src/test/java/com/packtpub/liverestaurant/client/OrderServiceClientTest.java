...
public class OrderServiceClientTest {
	...
	public   void testHandleCancelOrderRequest() throws Exception {
    	...
    	CancelOrderResponse cancelOrderResponse=(CancelOrderResponse) webServiceTemplate.marshalSendAndReceive(cancelOrderRequest,new ActionCallback(new URI("http://www.packtpub.com/OrderService/CancelOrdReq"),new Addressing10(),new URI("http://www.packtpub.com/LiveRestaurant/OrderService/schema")));
	...
	public   void testHandleOrderRequest() throws Exception {
    	...
    	PlaceOrderResponse placeOrderResponse=(PlaceOrderResponse) webServiceTemplate.marshalSendAndReceive(placeOrderRequest,new ActionCallback(new URI("http://www.packtpub.com/OrderService/OrdReq"),new Addressing10(),new URI("http://www.packtpub.com/LiveRestaurant/OrderService/schema")));
