...
public class OrderServiceClient {
	...
	private static InputStream isWrong;
	...
	public static void  main(String[] args) throws Exception {
		...
		isWrong = new OrderServiceClient().getClass().getResourceAsStream("placeOrderRequestWrong.xml");
		testPlaceOrderRequest();
		testPlaceOrderRequestWrong();
	}
	...
	private static final void testPlaceOrderRequestWrong() {
		 invokeWS(isWrong);
    }
